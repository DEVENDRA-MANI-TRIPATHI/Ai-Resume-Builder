      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="theme-text-secondary">
            Upload multiple resumes and analyze them against job requirements
          </p>
        </motion.div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              ...
              <div className="border-2 border-dashed theme-border rounded-lg p-8 text-center">
                ...
                <label
                  htmlFor="file-upload"
                  className="btn-primary px-6 py-3 rounded-lg cursor-pointer inline-block"
                >
                  Select Files
                </label>
              </div>
            ...
            {uploadedFiles.length > 0 && (
              ...
              >
                <div className="flex justify-between items-center mb-4">
                  <h3 className="font-semibold text-xl theme-text">
                ...
                <div className="space-y-3">
                  {uploadedFiles.map((file, index) => (
                    <motion.div
                      key={file.id}
                      className="flex items-center justify-between p-4 theme-bg-secondary rounded-lg"
                          ...
                          {file.score && (
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              <span className={`px-2 py-1 rounded-full text-xs ${
                                ...
                                file.status === 'good' ? 'bg-blue-100 text-blue-800' :
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-blue-800 font-medium">
                        Analyzing resumes with AI... This may take a few moments.
                      </span>
                    </div>
                  </motion.div>
                )}
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  <span className="theme-text-secondary">Total Resumes</span>
                  <span className="theme-text font-semibold">{uploadedFiles.length}</span>
                </div>
                <div className="flex justify-between">
                  <span className="theme-text-secondary">Excellent Match</span>
                  <span className="text-green-400 font-semibold">
                    {uploadedFiles.filter(f => f.status === 'excellent').length}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="theme-text-secondary">Good Match</span>
                  <span className="text-blue-400 font-semibold">
                    {uploadedFiles.filter(f => f.status === 'good').length}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="theme-text-secondary">Average Match</span>
                  <span className="text-yellow-400 font-semibold">
                    {uploadedFiles.filter(f => f.status === 'average').length}
                  </span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <motion.button 
                  ...
                  whileHover={{ scale: 1.02 }}
                  disabled={uploadedFiles.filter(f => f.score > 85).length === 0}
                >
